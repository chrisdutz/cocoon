...
public interface User {
    ...
    /** If the security handler provides a {@link java.security.Principal}
     * object, it should be stored into an attribute with the following
     * name.
     */
    String ATTRIBUTE_PRINCIPAL = User.class.getName() + ".Principal";
     ...
     * it only handles independently specified roles.
